...
const PremiumArticleDetails = ({data}) => {
      const { title, image, publisher, postedDate, viewCount, articleAuthorEmail, tags, description, articalAuthorPhoto, articleAuthorName, _id } = data || {}
      return (
            <div>
