...
const PriceCartForSubscription = ({plan,taka, time}) => {
      return (
            <div>
                  ...
                  <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="flex items-baseline text-gray-900 dark:text-white">
                              ...
                              <span className="text-5xl font-extrabold tracking-tight">{taka}</span>
                              <span className="ms-1 text-xl font-normal text-gray-500 dark:text-gray-400">/{time}</span>
                        </div>
                       ...
                       <Link to="/payment">
                        <button  type="button" className="text-white bg-red-700 hover:bg-black font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Take a subscription</button></Link>
                  </div>
...
export default PriceCartForSubscription;